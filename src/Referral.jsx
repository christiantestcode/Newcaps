...
export default function Referral() {
  ...
  <>
        ...
        <div className='overflow-x-hidden'>
                    ...
                    {referral && 
                    <div className={` ${referral ? 'block' : 'hidden'} absolute top-0 left-0 w-full h-[100vh] z-50 rounded-b-md`}
                        >
                        {referral && 
                        <div className='w-full max-w-[700px] h-fit mx-auto my-[20px] rounded-b-md z-50'>
                ...
                <div name='Nav' className=' w-full flex flex-row justify-between py-4 px-5 lg:px-40 text-[20px] font-bold text-[#F6F1F1] textS bg-[#279EFF]'>
                    <span className='bg-[#279EFF] w-fit px-2 py-1 rounded-md'>Cabangan High School</span>
                    <div onClick={()=> openreferralForm(true)} className='px-10 glass rounded-md pointer p-1 textS text-[20px] font-bold hidden md:flex cursor-pointer'>
                ...
                <div name='Referral' className='relative w-full h-fit lg:h-[90vh] z-10  min-h-[600px] bg-[#279EFF]'>
