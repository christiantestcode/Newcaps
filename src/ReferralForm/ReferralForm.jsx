...
export default function ReferralForm({close}) {
      ...
      transition: {
        ...
        staggerDirection: -1
            ...
            //teacher
              ...
              const sendtherequest = async (e)=>{
                ...
                const selectedStud = (studInfo) =>{
                  ...
                  setnameOfStudent(studInfo.lastname+' '+studInfo.firstname )
            ...
            const [studentlist,setstudentlist] = useState(false) 
                ...
                try{
                    const response= await Axios.get(`http://localhost:3500/getStud/account`)
                        if(!response.data) return alert('ERROR')
                         ...
                         const studData = (response.data.filter((name) => (name.userStatus === 'Active')))
                        setStudents(studData)
                        settofilter(studData)
                  }catch (err){
                    if (!err?.response) {
                      console.log(err)
                    }
              ...
              const filterstud = (e)=>{
                if(e){
                  setStudents(tofilter.filter((name)=> (name.lastname.toLowerCase()+name.firstname.toLowerCase()).includes(e.toLowerCase()) ))
                }else{
                  setStudents(tofilter)
                }
              }

              const clickedStud = (value) => {
                selectedStud(value)
  ...
  return (
    <>
      ...
      <form onSubmit={sendtherequest} className='w-full h-[full] z-50  overflow-y-auto overflow-x-hidden py-12 sm:p-4 poppins-light bg-white bg-opacity-90 rounded-b-md' >
          {/*content*/}
                <div className=''>
                                      {/*header*/}
                                      ...
                                      {/*body*/} 
                                                  ...
                                                  <div className='flex flex-col md:flex-row justify-start items-center '>   
                                                      ...
                                                      <div className='m-1 text-[18px] w-1/2 min-w-[310px]' >
                                                          <div>Referred by: (Teacher Name) <span className='text-[15px] text-red-500'>*</span></div>
                                                    ...
                                                    <div className='flex flex-col md:flex-row justify-start items-center'>   
                                                      <div className='m-1 text-[18px] w-1/2 min-w-[310px]' >
                                                          <div>Contact Number: <span className='text-[15px] text-red-500'>*</span> <span className='text-[gray]'>Ex. 9123456789</span> </div>
                                                    ...
                                                    <div onClick={()=> setstudentlist(true)} className=' mx-auto my-1 flex flex-row gap-x-[15px] shadow-sm shadow-black px-[15px] items-center w-fit bg-blue-500 hover:bg-blue-600 cursor-pointer rounded-md'>
                                                      <IoIosPersonAdd size={40} color='white' className=' '/>
                                                      <span className=' font-bold text-white text-[20px]'>Search & Select Student</span>
                                                    </div>

                                                    <div className='flex flex-col md:flex-row justify-start items-center '>   

                                                      <div className='m-1 text-[18px] w-1/2 min-w-[310px]' >
                                                          <div>Name of Student: <span className='text-[15px] text-red-500'>*</span></div>
                                                          <input type='text' required className=' w-full shadow-inner shadow-gray-500/50 border-[1px] border-gray-200 rounded-md px-2'
                                                      ...
                                                      <div className='flex flex-col m-1'>
                                                        <label className='text-[18px]'>Grade Level <span className='text-[15px] text-red-500'>*</span></label>
                                                      ...
                                                      <div className='flex flex-col m-1'> 
                                                            <label className='text-[18px]'>Gender <span className='text-[15px] text-red-500'>*</span></label>
                                    ...
                                    {/* Date of Referral: */}
                                                    ...
                                                    <div className='flex flex-col md:flex-row justify-between items-center'>   
                                                      <div className='m-1 text-[18px] w-1/2 min-w-[310px]' >
                                                          <div>Reason for Referral: <span className='text-[15px] text-red-500'>*</span></div>
                                                      ...
                                                      <div className='m-1 text-[18px] w-1/2 min-w-[310px]'>
                                                          <div>Initial Actions Taken: <span className='text-[15px] text-red-500'>*</span></div>
                                                          <textarea type='text' required className=' w-full max-h-[150px] h-[60px] shadow-inner shadow-gray-500/50 border-[1px] border-gray-200 rounded-md px-2'
                                      ...
                                      {/*footer*/}
                                              <div className="flex items-center justify-end border-t border-solid  border-slate-200 rounded-b">
                                                      ...
                                                      <input
                                                          className=" text-white-500 cursor-pointer bg-blue-500 hover:bg-blue-600 rounded-md text-[20px] text-white shadow-black shadow-sm background-transparent font-bold uppercase px-6 py-2 text-sm outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
      ...
      {/* CHOOSE STUDENT MODAL   */}
        {studentlist && 
        <>
            <div className="absolute top-[8%] left-0 w-[100%] z-50 h-[1px] flex justify-center poppins-light min-w-[300px] ">
                                {/*content*/}
                                    ...
                                    {/*body*/}
                                                <div className=" relative px-2 h-[300px] w-[350px] sm:w-full overflow-auto">
                                                  ...
                                                  <table className='min-w-[500px] text-left text-sm font-light poppins-light w-[500px] overflow-auto'>
                                                      <thead  className='border-b font-medium dark:border-neutral-500 sticky top-0  bg-white text-[15px]'>
                                                        <tr>
                                                          ...
                                                          <th scope="col" className="px-6 py-[3px]">Middle Name</th>
                                                        </tr>
                                                      </thead>
                                                  <tbody >
